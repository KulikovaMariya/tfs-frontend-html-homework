...
Единовременно должно отображаться только одно состояние, остальные должны быть скрыты с помощью CSS. Переключение между состояниями должно осуществляться с помощью классов (на body или основном контейнере).
